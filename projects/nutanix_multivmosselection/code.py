...
filename = "/var/lib/awx/projects/nutanix_multivmosselection/input.csv"
if os.path.exists(filename):
    ...
    while i < row:
      ...
      ip = inplist[i][4]
      ops = inplist[i][5]
      cmd = 'ansible-playbook /var/lib/awx/projects/nutanix_multivmosselection/nutanix_multivmosselection.yml -i /var/lib/awx/projects/nutanix_multivmosselection/hosts --extra-vars "servername=%s disksize=%s mem=%s cpu=%s ip=%s ops=%s"'%(servername,disksize,mem,cpu,ip,ops)
